...
class AdminFrame extends JFrame {
    ...
    AdminFrame() {
        ...
        a4.setBounds(160, 295, 130, 30);10
        ...
        UpdatePrice.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    double newPrice = Double.parseDouble(a1.getText()); 

                    st.executeUpdate("UPDATE BOOKS SET Price=" + newPrice + " WHERE uthor='" + author + "'");
        ...
        UpdateQty.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    String author = c2.getSelectedItem().toString()
;
                    int newQuantity = Integer.parseInt(a2.getText()); 

                    st.executeUpdate("UPDATE 
BOOKS SET Quantity=" + newQuantity + " WHERE Author='" + author + "'");
        ...
        Insert.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    st.executeUpdate("INSERT INTO BOOKS (Title, Author, Price, Quantity) VALUES ('" + title + "', '" + author + "', " + price + ", " + quantity + ")");
